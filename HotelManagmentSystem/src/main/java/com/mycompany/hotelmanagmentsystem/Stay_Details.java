 ...
 * @author HP
 */
public class Stay_Details extends javax.swing.JFrame {

    /**
     * Creates new form Stay_Details
     */
    public Stay_Details() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(Family, new org.netbeans.lib.awtextra.AbsoluteConstraints(52, 6, -1, -1));
        ...
        jPanel1.add(Single, new org.netbeans.lib.awtextra.AbsoluteConstraints(52, 33, -1, -1));

        jButton1.setText("Show available Room");
        jButton1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton1ActionPerformed(evt);
            }
        });
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(52, 72, -1, -1));
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 235, 63, -1));

        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(22, 27, -1, -1));

        jLabel2.setForeground(new java.awt.Color(255, 255, 153));
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(-3, -4, 730, 310));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        Family_Rooms f=new Family_Rooms();
        f.show();
        dispose();
        }
        else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Stay_Details.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Stay_Details().setVisible(true);
            }
        });
    }
